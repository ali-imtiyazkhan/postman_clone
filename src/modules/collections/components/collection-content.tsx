        ...
        <div className="h-full bg-zinc-950 text-zinc-100 flex flex-col">
            ...
            <div className="p-4 border-b border-zinc-800">
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Search"
                        className="w-full bg-zinc-900 border border-zinc-700 rounded-lg pl-10 pr-4 py-2 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-200 focus:border-transparent"
                    />
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8">
                ...
                <div className="space-y-3 w-full max-w-xs">
                    <button className="w-full bg-zinc-300 hover:bg-zinc-200 text-white py-2.5 px-4 rounded-lg font-medium text-sm transition-colors flex items-center justify-center space-x-2">
